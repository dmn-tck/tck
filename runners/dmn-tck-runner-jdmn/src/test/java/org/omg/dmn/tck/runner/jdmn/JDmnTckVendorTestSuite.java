 ...
 *
 */
public interface JDmnTckVendorTestSuite {
     ...
     */
    void beforeTest(Description description, TestSuiteContext context, TestCase testCase);
     ...
     *         a string message.
     */
    TestResult executeTest(Description description, TestSuiteContext context, TestCase testCase);
     ...
     * @param testCase a single test case that will be executed next.
     */
    void afterTest(Description description, TestSuiteContext context, TestCase testCase);
